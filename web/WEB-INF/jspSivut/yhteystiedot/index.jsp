                    ...
                    <div class="container">
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="/veneveistamo/yhteystiedot">Yhteystiedot</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <address>
                        <h2>Osoite:</h2>
                        <p>Veneveitämökuja 1, 00201 Helsinki</p>
                        <h2>Puhelin:</h2>
                        <p>09-10081628</p> <p>tai</p> <p>0400-10081985</p>
                        <h2>Aukioloajat:</h2>
                        <p>arkisin 9-15 tai sopimuksen mukaan, lauantaisin ja sunnuntaisin suljettu</p>
                    </address>
                </div>
                <div class="col-sm-6">
                    <img src="/veneveistamo/img/kartta/kartta.jpg" alt="Kartta" class="img-responsive img-rounded">
                </div>
            </div>
        </div>
        <!-- FOOTER -->
