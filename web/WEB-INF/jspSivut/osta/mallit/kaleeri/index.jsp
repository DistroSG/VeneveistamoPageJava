...
%>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6">
                <img id="theImage" src="/img/veneVarit/kaleeri/<%= mallit.getPolku(3)%>.png" class="img-responsive" alt="<%= mallit.getNimi(3)%>">
            </div>
            <div class="col-sm-6">
                ...
                <div class="btn-group" role="group" aria-label="...">
                    <input type="button" class="button 1 punainen selected" id="punainen" value="Punainen" onclick="pictureChange('theImage', '/img/veneVarit/kaleeri/<%= mallit.getPolku(5)%>.png', 'punainen')" title="Punainen">
                    <input type="button" class="button 1 sininen" id="sininen" value="Sininen" onclick="pictureChange('theImage', '/img/veneVarit/kaleeri/<%= mallit.getPolku(6)%>.png', 'sininen')" title="Sininen">
                    <input type="button" class="button 1 vihrea" id="vihrea" value="Vihrea" onclick="pictureChange('theImage', '/img/veneVarit/kaleeri/<%= mallit.getPolku(4)%>.png', 'vihrea')" title="Vihreä">
                    <input type="button" class="button 1 musta" id="musta" value="Musta" onclick="pictureChange('theImage', '/img/veneVarit/kaleeri/<%= mallit.getPolku(3)%>.png', 'musta')" title="Musta">
                    <input type="button" class="button 1 ruskea" id="ruskea" value="Ruskea" onclick="pictureChange('theImage', '/img/veneVarit/kaleeri/<%= mallit.getPolku(1)%>.png', 'ruskea')" title="Ruskea">
                    <input type="button" class="button 1 valkoinen" id="valkoinen" value="Valkoinen" onclick="pictureChange('theImage', '/img/veneVarit/kaleeri/<%= mallit.getPolku(2)%>.png', 'valkoinen')" title="Valkoinen">
                </div>
