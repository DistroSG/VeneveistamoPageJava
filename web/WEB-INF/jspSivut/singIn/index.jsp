    ...
    <body>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <form>
                        ...
                        <button type="submit" class="btn btn-default disabled">Kirjaudu</button>
                        <button type="button" class="btn btn-default" onclick="window.location.href = '/veneveistamo/singIn/unohtunutss'">Unohditko salasanasi?</button>
                    </form>
                </div>
                <div class="col-sm-6">
                    <form>
                        <h2>Etkö ole vielä rekisteröitynyt?</h2>
                        <h3>Paina tästä rekisteryäksesi</h3>

                        <button type="button" class="btn btn-default" onclick="window.location.href = '/veneveistamo/singIn/singup'">Rekisteröidy</button>
                    </form>
                </div>
            </div>
        </div>
        ...
        <footer class="footer">
            <div class="container">
                ...
                <p class="pull-left">© 2015 Parkki & Purkki ·  <a href="">Facebook</a> · <a href="">Twitter</a> · <a href="/veneveistamo/img/trash/kissa.gif">Älä vaivaudu!</a>
            </div>
        </footer>
